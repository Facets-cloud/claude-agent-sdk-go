...
```bash
go get github.com/Facets-cloud/claude-agent-sdk-go
```
...
**See [examples/structured_outputs](examples/structured_outputs) for more examples.**
...
- [Go API Reference](https://pkg.go.dev/github.com/Facets-cloud/claude-agent-sdk-go)
- [Examples](examples/)
- [Issues](https://github.com/Facets-cloud/claude-agent-sdk-go/issues)
